...
|  | 간단한 계산기 및 달력 구현 | Language |  **C++**|
|  | 누겟패키지 라이브러리를 활용 가능. |  | C++ 문법 습득. |
|  | 도서관리 프로그램 제어. |  | 객체지향언어 개념 이해 및 Git-Hub에 형상관리. |
|  | API를 이용하여 영화검색 프로그램 제어. |
...
|  | 도서관리 프로그램 제어. |  | API를 이용하여 영화검색 프로그램 제어. |
